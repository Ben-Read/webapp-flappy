...
app.post('/score', function(request, response){
    ...
    response.send("Cheers " + name + ", YOU BEAST" + "    Follow the link to play again:   " + "http://localhost:8080/" + "\r" + "\n" + "PRE-ORDER THE DLC NOW. Only £44.99");
});
...
var server = app.listen(8080, function() {
    ...
    console.log("Flappy DogBird Thing listening at http://%s:%s", host, port);
});
